...
# functions used from the game

# using numpy, create an empty board of 6 rows and 7 columns
def create_board():
    board = np.zeros((ROWS, COLS))
    return board


# add a piece to a given location, (set a position in the board as 1 or 2)
...
# scoring the state of a board after a piece has been droppped
...
# Alpha and beta are best scores a side can achieve assuming the opponent makes the best play removing many possible combinations to make it faster
